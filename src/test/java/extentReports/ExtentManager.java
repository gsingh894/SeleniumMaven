...
public class ExtentManager {
	...
	private static ExtentHtmlReporter getHtmlReporter() {
		System.out.println("filePath val is : "+filePath);
		htmlReporter = new ExtentHtmlReporter(filePath+"Facebook_Login_"+startTime+".html");
		// make the charts visible on report open
//		htmlReporter.config().setChartVisibilityOnOpen(true);
		htmlReporter.config().setDocumentTitle("Facebook Login Automation report");
		htmlReporter.config().setReportName("Validation Of Facebook Login Functionality");
	...
	public static String date(){
		...
		System.out.println("Date val is : "+date);
		return date;
	}
}